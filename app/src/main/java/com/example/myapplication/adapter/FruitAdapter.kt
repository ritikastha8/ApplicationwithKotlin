...
class FruitAdapter (
    ...
    ) : RecyclerView.Adapter<FruitAdapter.FruitsViewHolder>(){
    ...
    class FruitsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
     ...
     val title : TextView = itemView.findViewById(R.id.textView13)
     val desc : TextView = itemView.findViewById(R.id.textView12)
    }
